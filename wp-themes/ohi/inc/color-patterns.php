 ...
 */
function ohi_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filter OHI default saturation level.
	 *
	 * @since OHI 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation = absint( apply_filters( 'ohi_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.ohi-front-page) .entry-title,
...
.colors-custom .ohi-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.ohi-front-page .panel-content .recent-posts article,
...
.colors-custom.ohi-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	 ...
	 */
	return apply_filters( 'ohi_custom_colors_css', $css, $hue, $saturation );
}
